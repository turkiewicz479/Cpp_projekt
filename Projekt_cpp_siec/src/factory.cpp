    ...
    while (std::getline(is, line)) {
        ...
        switch (parsedLineData.element_type) {
            case ParsedLineData::ElementType::RAMP :
                factory.add_ramp(Ramp(static_cast<ElementID>(std::stoi(parsedLineData.parameters["id"])), std::stoi(parsedLineData.parameters["delivery-interval"])));
                break;

            case ParsedLineData::ElementType::WORKER :
                factory.add_worker(Worker(static_cast<ElementID>(std::stoi(parsedLineData.parameters["id"])),
            ...
            case ParsedLineData::ElementType::STOREHOUSE :
                factory.add_storehouse(Storehouse(static_cast<ElementID>(std::stoi(parsedLineData.parameters["id"]))));
                break;
